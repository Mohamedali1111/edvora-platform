...
- Frontend/mobile player and document viewer integration remains deferred, but the backend protected
  delivery boundaries are implemented for student quiz content/attempts, document download
  capability issuance, and Bunny video playback capability issuance.

 ...
 * features/admin/overview/overview.tsx); "deviceRequests" is the primary
 * feature for this milestone, backed by GET/approve/reject on
 * /admin/device-change-requests. Nothing else is added here until a real
 * admin-facing endpoint exists for it (e.g. instructor onboarding already
 * exists on the backend at /admin/instructors, but has no UI in this
 * milestone).
 */
export type AdminSection = "overview" | "deviceRequests";
